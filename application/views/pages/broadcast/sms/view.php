                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control datepicker" id="date_start" name="date_start" type="text" value="<?php echo $data['schedule_date'] ?>" style="text-align: center!important;" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                            <input type="text" id="time_start" name="time_start" class="form-control" value="<?php echo $data['schedule_time'] ?>" style="text-align: center!important;" disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="input-title" name="input-title" placeholder="<?php echo $this->lang->line("sms_broadcast_title_placeholder") ?>" autocomplete="off" value="<?php echo isset($data['title']) ? $data['title'] : ""; ?>" disabled>
                            ...
                            <div class="col-5">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        ...
                                        ?>
                                        <input class="custom-control-input group" data-id="0" id="Group0" type="checkbox" <?php echo $bActive == true ? "checked" : "" ?> disabled>
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox mb-3">
                                            ...
                                            <input class="custom-control-input group" <?php echo $bActive == true ? "checked" : "" ?> data-id="<?php echo $row['id_group_contact']; ?>" id="Group<?php echo $row['id_group_contact']; ?>" type="checkbox" disabled>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="input-data" name="input-data" rows="3" maxlength="140" resize="none" placeholder="<?php echo $this->lang->line("sms_broadcast_message_placeholder") ?>" disabled><?php echo isset($data['data']) ? $data['data'] : ""; ?></textarea>
