        ...
        <div class="col-lg-5 center-block col-centered">
            <div class="card card-pricing border-0 text-center mb-4">
                <div class="card-header bg-transparent">
                    <h4 class="text-uppercase ls-1 text-primary py-3 mb-0"><?php echo $this->lang->line("setting_integration_edit_telegram_topnav") ?></h4>
                </div>
                    ...
                    <div class="row" style="margin-top:20px">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="text" id="input-token" name="input-token" class="form-control" required placeholder="<?php echo $this->lang->line("setting_integration_telegram_token_placeholder") ?>" value="">
