        ...
        <div class="col-lg-8 center-block col-centered" style="background-color:white; padding-left:0px; padding-right:0px ;">
            <div class="card card-pricing border-0 mb-0">
                ...
                <div class="card-header bg-transparen text-center" style="padding-bottom: 1px; padding-top: 9px;">
                    <h4 class="text-uppercase ls-1 text-primary py-3 mb-0"><?php echo $this->lang->line("setting_integration_widget_new_topnav") ?></h4>
                </div>
            ...
            <div class="card card-pricing mb-4" id="phases">
                <div class="card-body px-lg-12 container-options">
                    ...
                    <div class="col-lg-12" id="etp_button" style="padding-top: 10px; display:block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="input-button" class="form-control" placeholder="<?php echo $this->lang->line("setting_integration_widget_edit_button_name_placeholder") ?>" maxlength="25" value="">
                            <span id="alert-button" style="font-size:13px; color:red;"></span>
                        </div>
                        ...
                        <a href="<?php echo base_url() . '/integration/add' ?>" class="btn btn-primary mb-1" style="margin-top:-8px"><?php echo $this->lang->line("setting_integration_widget_edit_btn_return") ?></a>
                        <button type="button" id="btn_etp_button" class="btn btn-success mb-1" style="margin-top:-8px"><?php echo $this->lang->line("setting_integration_widget_edit_btn_next") ?></button>
                    </div>
                    ...
                    <div class="col-lg-12" id="etp_title" style="padding-top: 5px; display:none">
                        <div class="form-group">
                            ...
                            <input type="text" id="nameWidget" class="form-control" placeholder="<?php echo $this->lang->line("setting_integration_widget_name_placeholder") ?>" maxlength="23" value="">
                            <span id="alert-title" style="font-size:13px; color:red;"></span>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" for="input-title"><?php echo $this->lang->line("setting_integration_widget_edit_title") ?></label>
                            <input type="text" id="input-title" class="form-control" placeholder="<?php echo $this->lang->line("setting_integration_widget_edit_title_placeholder") ?>" maxlength="23" value="">
                            <span id="alert-title" style="font-size:13px; color:red;"></span>
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" for="input-subtitle"><?php echo $this->lang->line("setting_integration_widget_edit_subtitle") ?></label>
                            <input type="text" id="input-subtitle" class="form-control" maxlength="100" placeholder="<?php echo $this->lang->line("setting_integration_widget_edit_subtitle_placeholder") ?>" value="">
                            <span id="alert-subtitle" style="font-size:13px; color:red;"></span>
                        </div>
                        <button type="button" id="btn_close_title" class="btn btn-primary mb-1"><?php echo $this->lang->line("setting_integration_widget_edit_btn_return") ?></button>
                        <button type="button" id="btn_etp_title" class="btn btn-success mb-1"><?php echo $this->lang->line("setting_integration_widget_edit_btn_save") ?></button>
                    </div>
                ...
                <div class="container-preview">
                    <div class="text-center container-preview-button" id="container-preview-button">
                        <input type="hidden" name="" id="input-color">
                        <div class="img">
                    ...
                    <div class="container-preview-inner" id="container-preview-inner" style="display:none">
                        <div class="card-info">
                            ...
                            <div class="title">
                                <strong id="title-msg"></strong>
                            </div><br>
                            <div class="description">
                                <span id="subtitle-msg"></span>
                            </div>
