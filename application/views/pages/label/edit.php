            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0"><?php echo $this->lang->line("label_edit_title") ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <?php echo form_open("label/save/$id"); ?>
                    <h6 class="heading-small text-muted mb-4"><?php echo $this->lang->line("label_edit_information") ?></h6>
                    <div class="pl-lg-1">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email"><?php echo $this->lang->line("label_name") ?></label>
                                    <input type="text" id="input-name" name="input-name" maxlength="30" class="form-control" placeholder="<?php echo $this->lang->line("label_name_placeholder") ?>" value="<?php echo $data['name']; ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <a href="<?php echo base_url(); ?>label"><button class="btn btn-primary" type="button"><?php echo $this->lang->line("label_btn_return") ?></button></a>
