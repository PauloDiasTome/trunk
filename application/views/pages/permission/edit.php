            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0"><?php echo $this->lang->line("permission_edit_title")  ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">

                    <?php function checkGroup($data, $permission)
                    {
                    ...
                    <?php echo form_open("permission/save/{$data['id_permission']}", array('onsubmit' => 'Send();')) ?>

                    <h6 class="heading-small text-muted mb-4"><?php echo $this->lang->line("permission_edit_information") ?></h6>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" maxlength="100" value="<?php echo $data['name']; ?>" placeholder="<?php echo $this->lang->line('permission_name_placeholder'); ?>">
                        ...
                        <div class="col-6">
                            <div class="container-permission">
                                    ...
                                    <div class="col-12">
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'contact' || $key == 'persona' || $key == 'label' || $key == 'block_list') { ?>
                                                <div class="form-check <?php echo checkPermission($data, $key) == true ? 'selected_opt' : '' ?>" style="display:none;">
                                ...
                                <div class="permissionBox">
                                    ...
                                    <div class="col-12">
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'user' || $key == 'replies' || $key == 'usergroup' || $key == 'usercall' || $key == 'permission') { ?>
                                                <div class="form-check <?php echo checkPermission($data, $key) == true ? 'selected_opt' : '' ?>" style="display:none;">
                                                    <li class="form-check-label" id="<?php echo $key; ?>" onclick="selectOption(this)"><?php echo lang($key); ?></li>
                                                </div>
                                            <?php  } ?>
                                ...
                                <div class="permissionBox">
                                    ...
                                    <div class="col-12">
                                        <?php foreach ($data as $key => $value) {
                                            if (
                                                $key == 'publication_facebook' || $key == 'publication_instagram' || $key == 'publication_whatsapp_newsletter' || $key == 'publication_whatsapp_community'
                        ...
                        <div class="col-6">
                            <div class="container-permission-preview">
                                ...
                                <!-- Dashboard -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "dashboard") == true ? 'block' : 'none' ?>">
                                    <div class="title-group single-option">
                                        <i class="far fa-chart-bar" style="width: 9px"></i>
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'dashboard') { ?>
                                                <label class="form-control-label" id="option__<?php echo $key; ?>" onclick="deselectGroup(this)"><?php echo lang($key); ?>
                                                    <?php if (checkPermission($data, "dashboard") == true) { ?>
                                                        <input type="hidden" class="inputHidden" name="<?php echo $key; ?>">
                                                    <?php } ?>
                                                </label>
                                            <?php  } ?>
                                        <?php } ?>
                                ...
                                <!-- Contatos -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "contact persona label block_list") == true ? 'block' : 'none' ?>">
                                    ...
                                    <div class="col-12">
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'contact' || $key == 'persona' || $key == 'label' || $key == 'block_list') { ?>
                                                <div class="form-check <?php echo checkPermission($data, $key) == true ? 'selected_opt' : '' ?>" style="display: <?php echo checkPermission($data, $key) == true ? 'block' : 'none' ?>">
                                                    <li class="form-check-label" id="option__<?php echo $key; ?>" onclick="deselectOption(this)"><?php echo lang($key); ?>
                                                        <?php if (checkPermission($data, $key) == true) { ?>
                                                            <input type="hidden" class="inputHidden" name="<?php echo $key; ?>">
                                                        <?php } ?>
                                                    </li>
                                                </div>
                                ...
                                <!-- Comunidade -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "community") == true ? 'block' : 'none' ?>">
                                    <div class="title-group single-option">
                                        <i class="fas fa-users" style="color:#FFAB00; width: 12px"></i>
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'community') { ?>
                                ...
                                <!-- Usuários -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "user replies usergroup usercall permission") == true ? 'block' : 'none' ?>">
                                    <div class="title-group multiple-options" onclick="showGroupPreview(this)">
                                        <i class="fas fa-user-friends text-orange"></i>
                                        <label class="form-control-label"><?php echo $this->lang->line('user') ?></label>
                                        <i class="fas fa-angle-right icon-angle"></i>
                                ...
                                <!-- Messenger -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "messenger") == true ? 'block' : 'none' ?>">
                                    <div class="title-group single-option">
                                        <i class="fas fa-comment-dots text-info"></i>
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'messenger') { ?>
                                ...
                                <!-- Publicações -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "publication_facebook publication_instagram publication_whatsapp_newsletter publication_whatsapp_community publication_whatsapp_broadcast publication_whatsapp_status publication_whatsapp_waba") == true ? 'block' : 'none' ?>">
                                    <div class="title-group multiple-options" onclick="showGroupPreview(this)">
                                        <i class="fas fa-bullhorn" style="color: #71b093!important;"></i>
                                        <label class="form-control-label"><?php echo $this->lang->line('publication') ?></label>
                                        <i class="fas fa-angle-right icon-angle"></i>
                                ...
                                <!-- ticket -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "ticket") == true ? 'block' : 'none' ?>">
                                    <div class="title-group single-option">
                                        <i class="fas fa-clipboard-list"></i>
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'ticket') { ?>
                                ...
                                <!-- kanban -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "kanban_attendance kanban_communication") == true ? 'block' : 'none' ?>">
                                    <div class="title-group multiple-options" onclick="showGroupPreview(this)">
                                        <i class="ni ni-archive-2 text-red"></i>
                                        <label class="form-control-label"><?php echo $this->lang->line('kanban') ?></label>
                                        <i class="fas fa-angle-right icon-angle"></i>
                                ...
                                <!-- report -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "report_call evaluate_report report_send") == true ? 'block' : 'none' ?>">
                                    <div class="title-group multiple-options" onclick="showGroupPreview(this)">
                                        <i class="ni ni-single-copy-04 text-success"></i>
                                        <label class="form-control-label"><?php echo $this->lang->line('report') ?></label>
                                        <i class="fas fa-angle-right icon-angle"></i>
                                ...
                                <!-- configuração -->
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "chatbot faq work_time templates company integration") == true ? 'block' : 'none' ?>">
                                    <div class="title-group multiple-options" onclick="showGroupPreview(this)">
                                        <i class="ni ni-settings-gear-65"></i>
                                        <label class="form-control-label"><?php echo $this->lang->line('config') ?></label>
                                        <i class="fas fa-angle-right icon-angle"></i>
                                ...
                                <div class="permissionBox" style="display: <?php echo checkGroup($data, "myinvoice") == true ? 'block' : 'none' ?>">
                                    <div class="title-group single-option">
                                        <i class="fas fa-donate"></i>
                                        <?php foreach ($data as $key => $value) {
                                            if ($key == 'myinvoice') { ?>
                    ...
                    <a href="<?php echo base_url(); ?>permission"><button class="btn btn-primary" type="button"><?php echo $this->lang->line("permission_btn_return"); ?></button></a>
