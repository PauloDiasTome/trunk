        ...
        <div class="col-10">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="mb-0"><?php echo $this->lang->line("persona_edit_title") ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-3 align-self-center">
                            <div class="box-picture-persona-config">
                                <div class="picture-persona transition-effect">
                                    ...
                                    <img src="<?php echo $persona_info['profile'] ? $persona_info['profile'] : base_url("assets/img/panel/image_placeholder.png") ?>">
                                    ...
                                    <input type="text" value="<?php echo $persona_info['profile'] ?>" name="file" id="input-file-hidden" style="display: none" />
                                </div>
                            </div>
                        </div>
                        <div class="col-9">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-name" name="input-name" value="<?php echo htmlspecialchars($persona_info['name'], ENT_QUOTES, 'UTF-8') ?>" class="form-control" maxlength="100" placeholder="<?php echo $this->lang->line("persona_name_placeholder") ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="select-channel"><?php echo $this->lang->line("persona_edit_selected_channel") ?></label>
                                        <select class="form-control" id="select-channel" disabled>
                                            <option data-id="<?php echo $persona_info["id"] ?>" value="<?php echo $persona_info["id_channel"] ?>"><?php echo $persona_info["channel"] ?></option>
                                        </select>
                ...
                <div class="card-footer persona-card">
                    ...
                    <div class="row" id="table-contacts-footer">
                        <div class="col-6">
                            <a href="<?php echo base_url(); ?>persona"><button class="btn btn-primary" type="button"><?php echo $this->lang->line("persona_edit_btn_return") ?></button></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">
                    <?php echo $this->lang->line("persona_participants_title") ?>
                </h5>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header b-bottom">
                ...
                <h5 class="modal-title">
                    <?php echo $this->lang->line("persona_import_title") ?>
                </h5>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer b-top">
                <div class="alert-import">
                    <img id="icon-preview" src="<?php echo base_url("assets/icons/panel/help_center.svg") ?>" title="<?php echo $this->lang->line('persona_alert_import_info') ?>">
                    <span class="alert-import-text"><?php echo $this->lang->line('persona_import_alert_import') ?></span>
                </div>
