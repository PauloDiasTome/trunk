    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <?php echo form_open("product/status/save/$id"); ?>
                    <h6 class="heading-small text-muted mb-4">Ticket status</h6>
                    <div class="pl-lg-1">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Nome</label>
                                    <input type="text" id="input-name" name="input-name" class="form-control" placeholder="Nome do status do produto(Exemplo: em análise)" value="<?php echo $data['name']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="textarea-message" name="textarea-message" rows="3" resize="none"><?php echo $data['message'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt--1">
                            <div class="col-lg-2">
                                <div class="custom-control custom-radio mb-2">
                                    <input class="custom-control-input" name="is_open" id="is_open" type="radio" <?php if ($data['is_close'] == 1) {
                                                                                                                        echo "checked";
                                                                                                                    } ?>>
                            ...
                            <div class="col-lg-4">
                                <div class="custom-control custom-radio mb-2">
                                    <input class="custom-control-input" name="is_close" id="is_close" type="radio" <?php if ($data['is_close'] == 2) {
                                                                                                                        echo "checked";
                                                                                                                    } ?>>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-8">
                                ...
                                <a href="<?php echo base_url(); ?>product/status"><button class="btn btn-primary" type="button">Voltar</button></a>
                            </div>
                        </div>
