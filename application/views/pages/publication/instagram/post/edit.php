                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo $this->lang->line("instagram_post_edit_title") ?></h3>
                            </div>
                        </div>
                    </div>

                    <?php echo form_open_multipart('publication/instagram/post/save', 'id="myform"'); ?>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input_title"><?php echo $this->lang->line("instagram_post_title") ?></label>
                                    <input type="text" class="form-control" name="input_title" id="input_title" maxlength="50" placeholder="<?php echo $this->lang->line("instagram_post_title") ?>" value="<?php echo $view[0]['title'] ?>">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="date_start"><?php echo $this->lang->line("instagram_post_date_scheduling") ?></label>
                                    <input type="text" class="form-control datepicker" name="date_start" id="date_start" maxlength="10" placeholder="<?php echo $this->lang->line("instagram_post_date_scheduling_placeholder") ?>" value="<?php echo explode(' ', $view[0]['schedule'])[0] ?>">
                            ...
                            <div class=" col-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="time_start"><?php echo $this->lang->line("instagram_post_hour_scheduling") ?></label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="channel_id"><?php echo $this->lang->line("instagram_post_select_channel") ?></label><br>
                                    <div id="myselect">
                                    ...
                                    <div id="list_insta" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input_data"><?php echo $this->lang->line("instagram_post_message") ?></label> (<label class="count-caracters" id="count_caracter">0</label>)
                                    <textarea class="form-control input_data" name="input_data" id="input_data" rows="3" placeholder="<?php echo $this->lang->line("instagram_post_message_placeholder") ?>" maxlength="1024" resize="none"><?php echo $view[0]['data'] ?></textarea>
                                        ...
                                        <div class="main-pw">
                                            <div class="preview-post">
                                                <div class="preview-post-header">
                                                    ...
                                                    <div class="profile">
                                                        <img src="<?php echo base_url("assets/img/panel/instagram.png"); ?>" alt="profile" id="picture_profile_insta">
                                                    </div>
                                                    <div class="name-insta" id=name_profile_insta>
                                                        <span>Instagram</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="input-file">
                                <input type="file" id="fileElem" accept=".jpg, .jpeg, .mp4" style="display:none;" onchange="handleFiles(this.files)">
                            </div>

                            <div class="col-lg-6" id="input_files">
                                <a href="#" id="fileSelect">
                                    <div class="input-files">
                                        <span><?php echo $this->lang->line("instagram_post_loading_arquive") ?></span>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="drop-area" id="dropArea" multiple ondrop="dropHandler(event);" ondragover="dragOverHandler(event);">
                                    ...
                                    <div class="drop-inner-title">
                                        <strong><?php echo $this->lang->line("instagram_post_title_drop") ?></strong>
                                    </div>
                                    <div class="drop-inner-text">
                                        <span><?php echo $this->lang->line("instagram_post_subtitle_drop") ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12">
                                <a href="<?php echo base_url(); ?>publication/instagram/post"><button class="btn btn-danger" type="button"><?php echo $this->lang->line("instagram_post_btn_cancel") ?></button></a>
                                <!-- <button class="btn btn-success" type="submit"><?php echo $this->lang->line("instagram_post_btn_save") ?></button> -->
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header b-bottom text-center">
                    <h6 class="modal-title w-100" id="modal-title-notification"><?php echo $this->lang->line("instagram_post_approval_no_records_modal_title") ?></h6>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="text-center font-weight-normal"><?php echo $this->lang->line("instagram_post_approval_no_records_modal_message") ?></p>
                        </div>
                    </div>
                </div>
