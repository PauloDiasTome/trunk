                    ...
                    <table class="table align-items-center table-flush" id="datatable-basic" cellspacing="0" style="width:100%;">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th><?php echo $this->lang->line("sms_broadcast_column_scheduling") ?></th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control mt-1" name="select-status" id="select-status" style="display:none">
                                <option value=""><?php echo $this->lang->line("sms_broadcast_filter_status_select") ?></option>
                                <option value="3"><?php echo $this->lang->line("sms_broadcast_datatable_column_status_processing") ?></option>
                                <option value="6"><?php echo $this->lang->line("sms_broadcast_datatable_column_status_sending") ?></option>
                                <option value="7"><?php echo $this->lang->line("sms_broadcast_datatable_column_status_paused") ?></option>
                                <option value="2"><?php echo $this->lang->line("sms_broadcast_datatable_column_status_send") ?></option>
                                <option value="5"><?php echo $this->lang->line("sms_broadcast_datatable_column_status_called_off") ?></option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer b-top p-footer">
                <button type="button" class="btn btn-secondary btn-box-shadow" data-dismiss="modal"><?php echo $this->lang->line("sms_broadcast_filter_btn_return") ?></button>
                <button type="button" class="btn btn-green" id="btn-search" data-dismiss="modal"><?php echo $this->lang->line("sms_broadcast_filter_btn_search") ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-export" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer b-top p-footer">
                <button type="button" class="btn btn-secondary btn-box-shadow" data-dismiss="modal"><?php echo $this->lang->line("sms_broadcast_export_btn_return") ?></button>
                <button type="button" class="btn btn-green" id="sendEmailExport" data-dismiss="modal"><?php echo $this->lang->line("sms_broadcast_export_btn_confirm") ?></button>
            </div>
        </div>
    </div>
</div>