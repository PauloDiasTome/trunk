    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-1 d-flex align-items-center">
                            <h3 class="mb-0"><?php echo $this->lang->line("whatsapp_broadcast_add_title") ?></h3>
                        </div>
                ...
                <?php echo form_open_multipart('publication/whatsapp/broadcast/save', 'id="myform"'); ?>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="input_title" id="input_title" maxlength="100" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_title") ?>" value="<?php echo $input_title != "" ? $input_title : "";  ?>">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker date_start" maxlength="10" name="date_start" id="date_start" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_date_scheduling_placeholder") ?>" value="<?php echo $date_start ?>">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                    <input type="text" class="form-control time" name="time_start" id="time_start" maxlength="5" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_hour_scheduling_placeholder") ?>" value="<?php echo $time_start ?>">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-control-label" for="channel_id"><?php echo $this->lang->line("whatsapp_broadcast_select_channel") ?></label><br>
                                <div id="myselect">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label class="custom-toggle mb-2">
                                <input type="checkbox" id="<?php echo $queryChannel == "null" ? "toggle-segmented-group" : "toggle-segmented" ?>" name="<?php echo $queryChannel == "null" ? "toggle-segmented-group" : "toggle-segmented" ?>">
                            ...
                            <label class="form-control-label title-toggle-view" for=""><?php echo $this->lang->line("whatsapp_broadcast_segments_campaign") ?></label>
                        </div>
                    </div>

                    <div class="row" id="segmented_group" name="<?php echo $select_segmented_group ?>" style="display:<?php echo $select_segmented_group != 0 ? "flex" : "none" ?>">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="select_segmented_group" id="select_segmented_group">
                                    ...
                                    <?php foreach ($selected_groups as $row) {
                                        if ($row['id_group_contact'] == $select_segmented_group) { ?>
                                            <option value="<?php echo $row['id_group_contact'] ?>" selected><?php echo $row['name'] ?></option>
                                        <?php } else { ?>
                    ...
                    <div class="row" style="display: none;">
                        <div class="col-12">
                            <label class="custom-toggle mb-2">
                                ...
                                <span class="custom-toggle-slider rounded-circle <?php echo $toggle_validity == 'off' ? '' : 'custom-toggle-slider-validity' ?>" data-label-off="<?php echo $this->lang->line("whatsapp_broadcast_automatic_response_no") ?>" data-label-on="<?php echo $this->lang->line("whatsapp_broadcast_automatic_response_yes") ?>"></span>
                            </label>
                    ...
                    <div class="row" id="date-validity" style="display: none">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="date_start_validity" id="date_start_validity" maxlength="10" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_date_scheduling_placeholder") ?>" value="<?php echo $date_start_validity != "" ? $date_start_validity : date('d/m/Y'); ?>">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                                    <input type="text" class="form-control time" name="time_start_validity" id="time_start_validity" maxlength="5" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_hour_scheduling_placeholder") ?>" value="<?php echo  $time_start_validity != "" ? $time_start_validity : date('H:i'); ?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group" id="label_chose_type" style="margin-bottom: 0px;">
                                <label class="form-control-label" for=""><?php echo $this->lang->line("whatsapp_broadcast_choose_type") ?></label>
                            </div>
                        ...
                        <div class="col-6" id="status_image" style="display: <?php echo $status_image ?>;">
                            ...
                            <div class="form-group">
                                <div class="box-img">
                                    <div class="container">
                                        <div class="text">
                                            <span><?php echo $this->lang->line("whatsapp_broadcast_type_photo") ?></span>
                                        </div>
                                        <div class="img">
                                            <img src="<?php echo base_url("assets/img/statusImage.png"); ?>" alt="">
                                        </div>
                                ...
                                <div class="alert-field-validation" id="alert_input_img_text" style="display: none;"><?php echo $this->lang->line("whatsapp_broadcast_alert_field_validation") ?></div>
                            </div>
                        </div>
                        ...
                        <div class="col-6" id="status_text" style="display: <?php echo $status_text ?>;">
                            <div class="form-group">
                                <div class="box-img">
                                    <div class="container">
                                        <div class="text">
                                            <span><?php echo $this->lang->line("whatsapp_broadcast_type_text") ?></span>
                                        </div>
                                        <div class="img">
                                            <img src="<?php echo base_url("assets/img/statusText.png"); ?>" alt="">
                                        </div>
                    ...
                    <div class="row" id="status_data" style="display: <?php echo $status_data ?>;">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="input-data" id="input-data" rows="7" resize="none" placeholder="<?php echo $this->lang->line("whatsapp_broadcast_status_message_placeholder") ?>"><?php echo $input_data != "" ? $input_data : ""; ?></textarea>
                                <?php echo form_error('input-data', '<div class="alert-status">', '</div>'); ?>
                                <span class="alert-field-validation" id="alert_textarea_message" style="display:none"><?php echo $this->lang->line("whatsapp_broadcast_alert_field_validation") ?></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12" id="input_files" style="display:<?php echo $input_files; ?>">
                            <a href="#" id="fileSelect">
                                <div class="input-container" id="">
                                    <div class="header">
                                        <div class="title">
                                            <span><?php echo $this->lang->line("whatsapp_broadcast_loading_arquive") ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-12">
                            <div class="drop-broadcast form-group" id="dropBrodcast" style="display:<?php echo $dropBroadcast ?>" multiple ondrop="dropHandler(event);" ondragover="dragOverHandler(event);">
                                ...
                                <div class="drop-inner-title">
                                    <b><?php echo $this->lang->line("whatsapp_broadcast_title_drop") ?></b>
                                </div>
                                <div class="drop-inner-text">
                                    <span><?php echo $this->lang->line("whatsapp_broadcast_subtitle_drop") ?></span>
                                </div>
                            </div>
                            <?php echo form_error('dropBrodcast', '<div class="alert-status">', '</div>'); ?>
                            <span class="alert-field-validation" id="alert_upload_media" style="display:none; margin-top: -21px;"><?php echo $this->lang->line("whatsapp_broadcast_alert_field_validation") ?></span>
                        </div>
                    </div>
                    ...
                    <div class="modal fade modal" id="modal-preview-campaign" tabindex="-1" role="dialog" aria-labelledby="modal-preview-campaign" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document" sytle="max-width: 465px">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="modal-title-notification"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview") ?></h6>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <p style="color: black;"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_movel") ?>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="channel_id_preview"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_channel_send") ?></label><br>
                                                <div id="myselect-preview-modal">
                                                    <select class="form-control" id="select-channel-preview" name="select-channel-preview" style="display:block">
                                                        <option value="0" style="display:block" selected="selected"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_select") ?></option>
                                                    ...
                                                    <?php echo form_error('others[]', '<div class="alert-status">', '</div>'); ?>
                                                    <div class="alert-field-validation" id="alert_select_channel"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_number_fone") ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12" style="margin-bottom: 10px">
                                            <label class="form-control-label" for="channel_id_preview"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_channel_receive") ?></label><br>
                                            ...
                                            <div class="alert-field-validation" id="alert_number_fone"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_number_fone") ?></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12" style="margin-top: 10px">
                                            <p style="font-size: 14px"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_optin") ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer p-footer" style="margin-top: -15px">
                                    <button type="button" class="btn btn-medium-blue" id="btn-send-preview"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_btn_send_preview") ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document" sytle="max-width: 465px">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <p style="font-weight: bold"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_preview_info_success") ?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <p style="color: black;"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview_text_preview_info_message") ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="<?php echo base_url(); ?>publication/whatsapp/broadcast"><button class="btn btn-danger" type="button"><?php echo $this->lang->line("whatsapp_broadcast_btn_cancel") ?></button></a>
                            <!-- <button class="btn btn-secondary" type="button" data-toggle="modal" data-target="" style="margin-right: 0" id="preview-campaign"><?php echo $this->lang->line("whatsapp_broadcast_campaign_preview") ?></button> -->
