            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_view") ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <h6 class="heading-small text-muted mb-4"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_edit_information") ?></h6>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group view-broadcast">
                                        <div class="view-title">
                                            <label class="form-control-label"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_title") ?>: </label><span> <?php echo $data['title']  ?></span>
                                        </div>

                                        <div class="view-schedule">
                                            <label class="form-control-label"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_date_scheduling") ?>: </label> <span> <?php echo explode(" ", $data['schedule'])[0]; ?></span>
                                        </div>

                                        <div class="view-schedule">
                                            <label class="form-control-label"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_hour_scheduling") ?>: </label> <span> <?php echo explode(" ", $data['schedule'])[1]; ?></span>
                                        </div>

                                        <div class="view-schedule">
                                            <label class="form-control-label"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_selected_channel") ?>: </label>
                                            <span> <?= $data['name'] . " (" . trim($data['channel']) . ")" ?></span>
                                        </div>

                                        <div class="view-schedule">
                                            <label class="form-control-label"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_selected_newsletter_edit_view") ?>: </label>
                                            <span> <?= $data['newsletter_name'] . " (" . trim($data['newsletter']) . ")" ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <?php if ($data['media_type'] == 33) { ?>
                                                        <div class="box-broadcast-approval message-poll" draggable="false">
                                                            ...
                                                            <div class="poll-multiple-answers">
                                                                ...
                                                                <span><?php echo $array["multiple_answers"] ? $this->lang->line("whatsapp_broadcast_newsletter_message_pollone_option_or_more") : $this->lang->line("whatsapp_broadcast_newsletter_message_poll_one_option") ?></span>
                                                            </div>
                                                            ...
                                                            <div class="show-wishes">
                                                                <span><?php echo $this->lang->line("whatsapp_broadcast_newsletter_show_votes") ?></span>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                        ...
                        <div class="col-6">
                            <h6 class="heading-small text-muted mb-4"><?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_view") ?></h6>
                                ...
                                <?php for ($i = 0; $i < count($log); $i++) { ?>
                                    ...
                                    <?php if ($log[$i]['log_status'] == 1) { ?>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $log[$i]['name'] ?> <?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_creation") ?></h6>
                                    ...
                                    <?php if ($log[$i]['log_status'] == 4) { ?>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $log[$i]['name'] ?> <?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_canceled") ?></h6>
                                                <p class="font-weight-bold text-xs mt-1 mb-0"><?= $log[$i]['log_creation'] ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if ($log[$i]['log_status'] == 7) { ?>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $log[$i]['name'] ?> <?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_edited") ?></h6>
                                                <p class="font-weight-bold text-xs mt-1 mb-0"><?= $log[$i]['log_creation'] ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if ($log[$i]['log_status'] == 8) { ?>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $log[$i]['name'] ?> <?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_send_now") ?></h6>
                                                <p class="font-weight-bold text-xs mt-1 mb-0"><?= $log[$i]['log_creation'] ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php if ($log[$i]['log_status'] == 9) { ?>
                                        ...
                                        <div class="timeline-block mb-3">
                                            ...
                                            <div class="timeline-content">
                                                <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $log[$i]['name'] ?> <?php echo $this->lang->line("whatsapp_broadcast_newsletter_timeline_resend") ?></h6>
                                                <p class="font-weight-bold text-xs mt-1 mb-0"><?= $log[$i]['log_creation'] ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
