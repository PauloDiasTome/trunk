            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-10">
                            <h3 class="mb-0"><?php echo $this->lang->line("ticket_edit_title") ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <?php echo form_open("ticket/save/$id"); ?>
                    <h6 class="heading-small text-muted mb-4"><?php echo $this->lang->line("ticket_edit_information") ?></h6>
                    <div class="pl-lg-1">

                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label"><?php echo $this->lang->line("ticket_creation") ?></label>
                                    <input type="text" class="form-control" disabled value="<?php echo $info['creation']; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label"><?php echo $this->lang->line("ticket_users") ?></label>
                                    <input type="text" class="form-control" disabled value="<?php echo $info['last_name']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label"><?php echo $this->lang->line("ticket_contact") ?></label>
                                    <input type="text" class="form-control" disabled value="<?php echo $info['full_name']; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="dropdown-menu links-responsivo" id="dropdown_ticket_company">
                                                ...
                                                <?php foreach ($company as $row) { ?>
                                                    <a class="dropdown-item opt <?php echo empty(set_value('input_ticket_company')) == true ? ($row['id_company'] == $info['id_company'] ? "OptSelected" : "") : (set_value('input_ticket_company') == $row['id_company'] ? "OptSelected" : "") ?>" id="<?php echo $row['id_company']; ?>" onclick="optSelected(this)"><?php echo $row['fantasy_name']; ?></a>
                                                <?php } ?>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="dropdown dropdown-responsivo">
                                        <div class="input-group mb-3">
                                            <input type="hidden" class="value-select" id="input_ticket_type" name="input_ticket_type" value="<?php echo $data['id_ticket_type']; ?>">
                                            ...
                                            <div class="dropdown-menu links-responsivo" id="dropdown_ticket_type">
                                                ...
                                                <?php foreach ($type as $row) { ?>
                                                    <a class="dropdown-item opt ticket_type_opt <?php echo empty(set_value('input_ticket_type')) == true ? ($row['id_ticket_type'] == $info['id_ticket_type'] ? "OptSelected" : "") : (set_value('input_ticket_type') == $row['id_ticket_type'] ? "OptSelected" : "") ?>" id="<?php echo $row['id_ticket_type']; ?>" onclick="optSelected(this)"><?php echo $row['name']; ?></a>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <select class="form-control" name="input-ticket-subtype" id="input-ticket-subtype">
                                        ...
                                        <?php if (isset($recover)) { ?>
                                            <?php foreach ($recover['subtype'] as $row) { ?>
                                                <option class="ticket-subtype" value="<?php echo $row['id_ticket_type']; ?>" <?php echo set_value('input-ticket-subtype') == $row['id_ticket_type'] ? "selected" : "" ?>><?php echo $row['name']; ?></option>
                                            <?php } ?>
                                        <?php } else { ?>
                                            <?php foreach ($subtype as $row) { ?>
                                                <option class="ticket-subtype" value="<?php echo $row['id_ticket_type']; ?>" <?php echo $row['id_ticket_type'] == $info['id_subtype'] ? "selected" : ""; ?>><?php echo $row['name']; ?> </option>
                                            <?php  } ?>
                                        <?php  } ?>
                                    </select>
                                </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="dropdown-menu links-responsivo" id="dropdown_ticket_status">
                                                ...
                                                <?php foreach ($status as $row) { ?>
                                                    <a class="dropdown-item opt <?php echo empty(set_value('input_ticket_status')) == true ? ($row['id_ticket_status'] == $info['id_ticket_status'] ? "OptSelected" : "") : (set_value('input_ticket_status') == $row['id_ticket_status'] ? "OptSelected" : "") ?>" id="<?php echo $row['id_ticket_status']; ?>" onclick="optSelected(this)"><?php echo $row['name']; ?></a>
                                                <?php } ?>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <textarea class="form-control" id="input-comment" name="input-comment" rows="10" resize="none" maxlength="1500"><?php echo (set_value('input-comment')) ? set_value('input-comment') : $info['comment']; ?></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="modalTicketType__sla" name="modalTicketType__sla">
