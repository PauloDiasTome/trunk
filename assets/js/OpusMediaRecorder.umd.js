! function (e, t) {
    ...
    return function (e) {
        ...
        (function (t) {
            ...
            var u, l = n(2),
                p = l.EventTarget,
                f = l.defineEventAttribute,
                d = (0, n(3).detect)(),
                h = t.AudioContext || t.webkitAudioContext,
                y = function (e) {
                    function n(e) {
                        ...
                        var i = r.mimeType,
                            ...
                            u = (r.videoBitsPerSecond, r.bitsPerSecond),
                            l = o.encoderWorkerFactory,
                            p = o.OggOpusEncoderWasmPath,
                            f = o.WebMOpusEncoderWasmPath;
                        if ((t = s(this, a(n).call(this)))._stream = e, t._state = "inactive", t._mimeType = i || "", t._audioBitsPerSecond = c || u, t.workerState = "inactive", !n.isTypeSupported(t._mimeType)) throw new TypeError("invalid arguments, a MIME Type is not supported");
                        ...
                        var h = "";
                        return document.currentScript ? h = document.currentScript.src : self.location && (h = self.location.href), h = h.substr(0, h.lastIndexOf("/")) + "/encoderWorker.umd.js", "function" == typeof n.encoderWorker && (h = URL.createObjectURL(new Blob(["(".concat(n.encoderWorker, ")()")]))), t._workerFactory = "function" == typeof l ? l : function (e) {
                            return new Worker(h)
                        }, t._spawnWorker(), t
                    }
                    var r, u, l;
                    return function (e, t) {
                        ...
                        value: function (e) {
                            ...
                            if ("audio" !== r || "ogg" !== o && "webm" !== o && "wave" !== o && "wav" !== o) return !1;
                            switch (o) {
                                case "ogg":
                                case "webm":
                                    if ("opus" !== i && i) return !1;
                                    break;
                                case "wave":
                                case "wav":
                                    if (i) return !1
                        ...
                        value: function () {
                            var e = this;
                            this.worker = this._workerFactory(), this.worker.onmessage = function (t) {
                            ...
                            switch (e) {
                                ...
                                case "init":
                                    ...
                                    this.worker.postMessage({
                                        ...
                                        channelCount: s,
                                        bitsPerSecond: a
                                    }), this.workerState = "encoding", this.source.connect(this.processor), this.processor.connect(this.context.destination);
                            ...
                            switch (o) {
                                case "readyToInit":
                                    var s = this.sampleRate,
                                        a = this.channelCount;
                                    this.workerState = "readyToInit", "recording" === this.state && this._postMessageToWorker("init", {
                                        sampleRate: s,
                                        channelCount: a,
                                ...
                                case "lastEncodedData":
                                    ...
                                    (n = new t.Event("dataavailable")).data = c, this.dispatchEvent(n), "lastEncodedData" === o && (n = new t.Event("stop"), this.dispatchEvent(n), this.workerState = "closed")
                            }
                        }
                    }, {
                        key: "_onerrorFromWorker",
                        value: function (e) {
                            this.source.disconnect(), this.processor.disconnect(), this.worker.terminate(), this.workerState = "closed";
                            var n = ["FileName: " + e.filename, "LineNumber: " + e.lineno, "Message: " + e.message].join(" - "),
                                r = new t.Event("error");
                            r.name = "UnknownError", r.message = n, this.dispatchEvent(r)
                        }
                    }, {
                        ...
                        value: function (e) {
                            ...
                            this.processor.onaudioprocess = function (r) {
                                for (var o = r.inputBuffer, i = (r.playbackTime, o.sampleRate, o.length), s = o.duration, a = o.numberOfChannels, c = new Array(a), u = 0; u < a; u++) c[u] = o.getChannelData(u);
                                var l = {
                                    channelBuffers: c,
                                    length: i,
                                    duration: s
                                };
                                t._postMessageToWorker("pushInputData", l), (n += s) >= e && (t._postMessageToWorker("getEncodedData"), n = 0)
                            }
                        }
                    }, {
                        key: "start",
                        value: function () {
                            ...
                            if ("inactive" !== this.state) throw new Error("DOMException: INVALID_STATE_ERR, state must be inactive.");
                            if (e < 0) throw new TypeError("invalid arguments, timeslice should be 0 or higher.");
                            e /= 1e3, "closed" === this.workerState && this._spawnWorker(), this.context = new h;
                            var t = this.stream.getAudioTracks();
                            if (!t[0]) throw new Error("DOMException: UnkownError, media track not found.");
                            if (this.channelCount = t[0].getSettings().channelCount || 1, this.sampleRate = this.context.sampleRate, this.source = this.context.createMediaStreamSource(this.stream), this.processor = this.context.createScriptProcessor(4096, this.channelCount, this.channelCount), this._state = "recording", this._enableAudioProcessCallback(e), "readyToInit" === this.workerState) {
                        ...
                        key: "stop",
                        value: function () {
                            if ("inactive" === this.state) throw new Error("DOMException: INVALID_STATE_ERR, state must NOT be inactive.");
                            this.source.disconnect(), this.processor.disconnect(), this.context.close(), this._postMessageToWorker("done"), this._state = "inactive"
                        }
                    }, {
                        key: "pause",
                        value: function () {
                            if ("inactive" === this.state) throw new Error("DOMException: INVALID_STATE_ERR, state must NOT be inactive.");
                            this.source.disconnect(), this.processor.disconnect();
                            var e = new t.Event("pause");
                            this.dispatchEvent(e), this._state = "paused"
                        }
                    }, {
                        key: "resume",
                        value: function () {
                            ...
                            this.dispatchEvent(e), this._state = "recording"
                        }
                    }, {
                        key: "requestData",
                        value: function () {
                    ...
                    }]) && i(r.prototype, u), l && i(r, l), n
                }();
            ["start", "stop", "dataavailable", "pause", "resume", "error"].forEach(function (e) {
                return f(y.prototype, e)
            }), d && "edge" === d.name && (u = Worker.prototype.postMessage, Worker.prototype.postMessage = function (e) {
                arguments.length > 1 && void 0 !== arguments[1] && arguments[1], u.apply(this, [e])
            }), e.exports = y
        }).call(this, n(1))
    }, function (e, t) {
        var n;
        ...
        "use strict";
        n.r(t), n.d(t, "defineEventAttribute", function () {
            return v
        ...
        s.prototype = {
            ...
            stopImmediatePropagation() {
                const e = i(this);
                e.stopped = !0, "function" == typeof e.event.stopImmediatePropagation && e.event.stopImmediatePropagation()
            },
            get bubbles() {
            ...
            preventDefault() {
                const e = i(this);
                null == e.passiveListener ? e.event.cancelable && (e.canceled = !0, "function" == typeof e.event.preventDefault && e.event.preventDefault()) : console.warn("Event#preventDefault() was called from a passive listener:", e.passiveListener)
            },
            ...
            Object.defineProperty(e, `on${t}`, function (e) {
                return {
                    get() {
                        let t = y(this).get(e);
                        for (; null != t;) {
                            if (t.listenerType === d) return t.listener;
                            t = t.next
                        }
                        return null
                    },
                    set(t) {
                        ...
                        let r = null,
                            o = n.get(e);
                        for (; null != o;) o.listenerType === d ? null !== r ? r.next = o.next : null !== o.next ? n.set(e, o.next) : n.delete(e) : r = o, o = o.next;
                        if (null !== t) {
                            const o = {
                                listener: t,
                                listenerType: d,
        ...
        w.prototype = {
            addEventListener(e, t, n) {
                ...
                let a = r.get(e);
                if (void 0 === a) return r.set(e, s), !0;
                let c = null;
                for (; null != a;) {
                    if (a.listener === t && a.listenerType === i) return !1;
                    c = a, a = a.next
                }
                return c.next = s, !0
            },
            removeEventListener(e, t, n) {
                ...
                let i = null,
                    s = r.get(e);
                for (; null != s;) {
                    if (s.listener === t && s.listenerType === o) return null !== i ? i.next = s.next : null !== s.next ? r.set(e, s.next) : r.delete(e), !0;
                    i = s, s = s.next
                }
                return !1
            },
            dispatchEvent(e) {
                ...
                let s = null;
                for (; null != r;) {
                    if (r.once ? null !== s ? s.next = r.next : null !== r.next ? t.set(n, r.next) : t.delete(n) : s = r, p(o, r.passive ? r.listener : null), "function" == typeof r.listener) try {
                        r.listener.call(this, o)
                    } catch (e) {
                        "undefined" != typeof console && "function" == typeof console.error && console.error(e)
                    } else r.listenerType !== d && "function" == typeof r.listener.handleEvent && r.listener.handleEvent(o);
                    if (l(o)) break;
                    r = r.next
                }
                return p(o, null),
            ...
            configurable: !0,
            writable: !0
        }), "undefined" != typeof window && void 0 !== window.EventTarget && Object.setPrototypeOf(w.prototype, window.EventTarget.prototype), t.default = w
    }, function (e, t, n) {
        "use strict";
        (function (e) {
            ...
            function c(e) {
                ...
                return c ? c.length < i && (c = c.concat(function (e) {
                    ...
                    return t
                }(i - c.length))) : c = [], new n(r, c.join("."), u(e))
            }
            ...
            }, t.parseUserAgent = c, t.detectOS = u, t.getNodeVersion = l
        }).call(this, n(4))
    }, function (e, t) {
        var n, r, o = e.exports = {};
