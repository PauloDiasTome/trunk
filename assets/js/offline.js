(function() {
    ...
    d = function(a, b) {
        ...
        for (c = a, h = b.split("."), d = e = 0, f = h.length; f > e && (g = h[d], c = c[g], 
        "object" == typeof c); d = ++e) ;
        ...
        }, d(window.XMLHttpRequest, c), null != window.XDomainRequest ? (b = window.XDomainRequest, 
    ...
    c = [], f = !1, d = function(a) {
        ...
        j = a.xhr, g = a.url, f = a.type, h = a.user, d = a.password, b = a.body, j.abort(), 
        j.open(f, g, !0, h, d), e = j.headers;
        ...
        var b, d, f, g, h, i;
        for (Offline.trigger("requests:flush"), h = {}, b = 0, f = c.length; f > b; b++) g = c[b], 
        ...
        return Offline.getOption("requests") !== !1 ? (Offline.on("confirmed-up", function() {
            ...
            }, e) ? null === g.onprogress ? (g.addEventListener("error", f, !1), g.addEventListener("timeout", f, !1)) : (b = g.onreadystatechange, 
    ...
    for (d = [ "up", "down" ], b = 0, c = d.length; c > b; b++) e = d[b], (document.querySelector("script[data-simulate='" + e + "']") || localStorage.OFFLINE_SIMULATE === e) && (null == Offline.options && (Offline.options = {}), 
    null == (a = Offline.options).checks && (a.checks = {}), Offline.options.checks.active = e);
    ...
    f = function(a) {
        ...
        return g = f(b), document.body.appendChild(g), null != Offline.reconnect && Offline.getOption("reconnect") && (g.appendChild(f(a)), 
        c = g.querySelector(".offline-ui-retry"), h = function(a) {
        ...
        return l(), Offline.on("up", function() {
            ...
            var a, b, c;
            return d("offline-ui-waiting"), k("offline-ui-connecting"), a = m(Offline.reconnect.remaining), 
            b = a[0], c = a[1], e.setAttribute("data-retry-in-value", b), e.setAttribute("data-retry-in-unit", c);
        }), Offline.on("reconnect:stopped", function() {
            return k("offline-ui-connecting offline-ui-waiting"), e.setAttribute("data-retry-in-value", null), 
