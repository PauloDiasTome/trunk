...
function createBroadcast(data) {
    ...
    textArea.placeholder = GLOBAL_LANG.telegram_channel_edit_broadcast_placeholder;
    ...
    text_caracter.textContent = GLOBAL_LANG.telegram_channel_text_caracter;
...
function callAlert(verify) {
    ...
    switch (verify) {
        case "limit":
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_dropzone_title,
                text: GLOBAL_LANG.telegram_channel_alert_dropzone_text,
                type: "warning",
                confirmButtonColor: '#3085d6',
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_dropzone_confirmButtonText,
                cancelButtonClass: "btn btn-secondary"
            });
            break;
        case "maxSize":
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_dropzone_two_title,
                text: GLOBAL_LANG.telegram_channel_alert_dropzone_two_text,
                type: "warning",
                confirmButtonColor: '#3085d6',
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_dropzone_two_confirmButtonText,
                cancelButtonClass: "btn btn-secondary"
            });
            break;
        case "png":
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_dropzone_three_title,
                text: GLOBAL_LANG.telegram_channel_alert_dropzone_three_text,
                type: "warning",
                confirmButtonColor: '#3085d6',
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_dropzone_three_confirmButtonText,
                cancelButtonClass: "btn btn-secondary"
            });
            break;
        case "extensions":
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_dropzone_three_title,
                text: GLOBAL_LANG.telegram_channel_alert_dropzone_three_extensions,
                type: "warning",
                confirmButtonColor: '#3085d6',
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_dropzone_three_confirmButtonText,
                cancelButtonClass: "btn btn-secondary"
...
function getGroups(id_channel) {
    ...
    $("#select_segmented_group").append(`<option value="0">${GLOBAL_LANG.telegram_channel_segments_select_group_placeholder}</option>`);
    ...
    $('#datatable-basic').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                targets: 4,
                render: function (data, type, full, meta) {
                    let ret = `<span class="badge badge-sm badge-secondary">${GLOBAL_LANG.telegram_channel_datatable_column_status_processing}</span>`
                    switch (full.status) {
                        case '2':
                            ret = `<span class="badge badge-sm badge-success">${GLOBAL_LANG.telegram_channel_datatable_column_status_send}</span>`
                            break;
                        case '1':
                        case '3':
                        case '7':
                            ret = `<span class="badge badge-sm badge-secondary">${GLOBAL_LANG.telegram_channel_datatable_column_status_processing}</span>`
                            break;
                        case '5':
                            ret = `<span class="badge badge-sm badge-danger">${GLOBAL_LANG.telegram_channel_datatable_column_status_called_off}</span>`
                            break;
                        case '6':
                            switch (full.is_paused) {
                                case "1":
                                    ret = `<span class="badge badge-sm badge-warning">${GLOBAL_LANG.telegram_channel_datatable_column_status_paused}</span>`
                                    break;
                                case "2":
                                    ret = `<span class="badge badge-sm badge-info">${GLOBAL_LANG.telegram_channel_datatable_column_status_sending}</span>`
                                    break;
                            }
                            break;
                ...
                render: function (data, type, full, meta) {
                    ...
                    let res = `<div class="dropleft">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="multiDropdownMenu">
                                            <a id="${full.token}" class="dropdown-item table-action-view action" style="cursor: pointer">
                                                ...
                                                <span>${GLOBAL_LANG.telegram_channel_datatable_column_action_view}</span>
                                            </a>`
                    ...
                    switch (full.status) {
                        ...
                        case "6":
                            switch (full.is_paused) {
                                case "1":
                                    res += `<a token="${full.token}" class="dropdown-item table-action-resume action-resume" style="cursor: pointer" data-toggle='tooltip' data-placement='right' title='${GLOBAL_LANG.telegram_channel_datatable_column_action_resume_distribution}'> 
                                                <div style="width: 24px; display: inline-block"> 
                                                    <i class="far fa-play-circle" style="font-size: 13pt"></i>
                                                </div>
                                                <span>${GLOBAL_LANG.telegram_channel_datatable_column_action_resume}</span>
                                            </a>`
                                    break;
                                case "2":
                                    res += `<a token="${full.token}" class="dropdown-item table-action-pause action-pause" style="cursor: pointer" data-toggle='tooltip' data-placement='right' title='${GLOBAL_LANG.telegram_channel_datatable_column_action_pause_distribution}'> 
                                                <div style="width: 24px; display: inline-block"> 
                                                    <i class='far fa-pause-circle' style="font-size: 13pt"></i>
                                                </div>
                                                <span>${GLOBAL_LANG.telegram_channel_datatable_column_action_pause}</span>
                                            </a>`
                                    break;
                            }
                            break;
                    ...
                    res += `<a id="${full.token}" class="dropdown-item ${full.status == 4 ? 'table-action-deleted' : (full.status == 5 || full.status == 2 || full.status == 4 ? 'table-action-deleted' : 'table-action-delete')} action" style="cursor: pointer">
                                ...
                                <span>${GLOBAL_LANG.telegram_channel_datatable_column_action_cancel}</span>
                            </a>
                            ...
                            style="cursor: pointer; display:${(full.status != 3) ? containsSupport(USER_EMAIL) == true ? 'block' : 'none' : 'none'}">
                                ...
                                <span>${GLOBAL_LANG.telegram_channel_alert_resend}</span>
                           </a>
                            <a id="${full.token}" class="dropdown-item ${(full.status == 4 || full.status == 5) ? 'table-action-disabled disabled' : 'table-action-edit'}"  
                                style="cursor: pointer; display: none;" title="${(full.status == 4 || full.status == 5) ? alertEditDatatable(full.status) : GLOBAL_LANG.telegram_channel_datatables_edit_column_action}">
                                <div style="width: 24px; display: inline-block"> 
                                    <i class="far fa-edit" style="font-size: 12pt; margin-left: 3px"></i>
                                </div>
                                <span>${GLOBAL_LANG.telegram_channel_datatables_edit_column_action}</span>
                            </a>
                        </div>
                     </div>
                  </div>`
...
function alertErrors(data) {
    if (data.errors?.code == "TA-023") {
        swal({
            title: GLOBAL_LANG.telegram_channel_error_title,
            text: `${GLOBAL_LANG.telegram_channel_error_ta023} (${data.errors.code})`,
            type: "error",
            buttonsStyling: !1,
    ...
    if (data.errors?.code == "TA-024") {
        swal({
            title: GLOBAL_LANG.telegram_channel_error_title,
            text: `${GLOBAL_LANG.telegram_channel_error_ta024} (${data.errors.code})`,
            type: "error",
            buttonsStyling: !1,
            confirmButtonClass: "btn btn-danger"
        });
...
$(document).ready(function () {
    ...
    if (multiselectAdd != null && !edit) {
        ...
        select = new MSFmultiSelect(
            ...
            width: "100%",
            height: 47,
            placeholder: GLOBAL_LANG.telegram_channel_select,
        ...
        $("body").on("change", "label li input", function () {
            ...
            if (options.length === 0) {
                ...
                $("#select_segmented_group").find("option").remove();
                $("#select_segmented_group").append(`<option value="0">${GLOBAL_LANG.telegram_channel_segments_select_group_placeholder}</>`);
        ...
        $("#datatable-basic").on("click", ".table-action-view", function () {
            window.location.href = "channel/view/" + this.id;
        });

        $("#datatable-basic").on("click", ".table-action-edit", function () {
            window.location.href = "channel/edit/" + this.id;
        });

        $("#datatable-basic").on("click", ".table-action-resend", function () {
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_resend_title,
                text: GLOBAL_LANG.telegram_channel_alert_resend_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                confirmButtonClass: "btn btn-success",
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_resend_confirmButtonText,
                cancelButtonClass: "btn btn-danger",
                cancelButtonText: GLOBAL_LANG.telegram_channel_alert_resend_cancelButtonText,
            }).then(t => {
                if (t.value == true) {
                    $.post(document.location.origin + "/publication/whatsapp/broadcast/resend/" + this.id, function (data) {
                        if (data.success?.status == true) {
                            t.value && swal({
                                title: GLOBAL_LANG.telegram_channel_alert_resend_two_title,
                                text: GLOBAL_LANG.telegram_channel_alert_resend_two_text,
                                type: "success",
                                buttonsStyling: !1,
                                confirmButtonClass: "btn btn-success"
                            });
        ...
        $("#datatable-basic").on("click", ".table-action-delete", function () {
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_delete_title,
                text: GLOBAL_LANG.telegram_channel_alert_delete_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                confirmButtonClass: "btn btn-success",
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_delete_confirmButtonText,
                cancelButtonClass: "btn btn-danger",
                cancelButtonText: GLOBAL_LANG.telegram_channel_alert_delete_cancelButtonText,
            }).then(t => {
                if (t.value == true) {
                    $.post("channel/cancel/" + this.id, function (data) {

                        if (data.errors?.code == "TA-027") {
                            t.value && swal({
                                title: GLOBAL_LANG.telegram_channel_validation_cancel_title,
                                text: GLOBAL_LANG.telegram_channel_validation_cancel_description,
                                type: "error",
                                buttonsStyling: !1,
                                confirmButtonClass: "btn btn-danger"
                            });
                        ...
                        if (data.success?.status === true) {
                            t.value && swal({
                                title: GLOBAL_LANG.telegram_channel_alert_delete_two_title,
                                text: GLOBAL_LANG.telegram_channel_alert_delete_two_text,
                                type: "success",
                                buttonsStyling: !1,
                                confirmButtonClass: "btn btn-success"
                            });
        ...
        $("#datatable-basic").on("click", ".table-action-pause", function () {
            ...
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_broadcast_title,
                text: GLOBAL_LANG.telegram_channel_alert_broadcast_pause_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                confirmButtonClass: "btn btn-success",
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_broadcast_confirmButtonText,
                cancelButtonClass: "btn btn-danger",
                cancelButtonText: GLOBAL_LANG.telegram_channel_alert_broadcast_cancelButtonText,
            }).then(t => {
                if (t.value == true) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.errors?.code == "TA-027") {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_error_broadcast_title,
                                    text: GLOBAL_LANG.telegram_channel_error_broadcast_message,
                                    type: "error",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-danger"
                                });
                            ...
                            if (data.success?.status === true) {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_alert_broadcast_two_title,
                                    text: GLOBAL_LANG.telegram_channel_alert_broadcast_pause_two_text,
                                    type: "success",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-success"
                                });
        ...
        $("#datatable-basic").on("click", ".table-action-resume", function () {
            ...
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_broadcast_title,
                text: GLOBAL_LANG.telegram_channel_alert_broadcast_resume_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success?.status === true) {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_alert_broadcast_two_title,
                                    text: GLOBAL_LANG.telegram_channel_alert_broadcast_resume_two_text,
                                    type: "success",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-success"
                                });
        ...
        $("#btn-cancel").on("click", function () {
            ...
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_group_delete_title,
                text: GLOBAL_LANG.telegram_channel_alert_group_delete_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                confirmButtonClass: "btn btn-success",
                confirmButtonText: GLOBAL_LANG.telegram_channel_alert_group_delete_confirmButtonText,
                cancelButtonClass: "btn btn-danger",
                cancelButtonText: GLOBAL_LANG.telegram_channel_alert_group_delete_cancelButtonText,
            }).then(t => {
                if (t.value == true) {
                    $.ajax({
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            if (data.success?.status === true) {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_alert_group_delete_two_title,
                                    text: GLOBAL_LANG.telegram_channel_alert_group_delete_two_text,
                                    type: "success",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-success"
                                });
        ...
        $("#btn-pause").on("click", function () {
            ...
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_broadcast_title,
                text: GLOBAL_LANG.telegram_channel_alert_broadcast_pause_all_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success?.status === true) {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_alert_broadcast_two_title,
                                    text: GLOBAL_LANG.telegram_channel_alert_broadcast_pause_two_all_text,
                                    type: "success",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-success"
                                });
        ...
        $("#btn-resume").on("click", function () {
            ...
            swal({
                title: GLOBAL_LANG.telegram_channel_alert_broadcast_title,
                text: GLOBAL_LANG.telegram_channel_alert_broadcast_resume_all_text,
                type: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                reverseButtons: true,
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success?.status === true) {
                                t.value && swal({
                                    title: GLOBAL_LANG.telegram_channel_alert_broadcast_two_title,
                                    text: GLOBAL_LANG.telegram_channel_alert_broadcast_resume_two_all_text,
                                    type: "success",
                                    buttonsStyling: !1,
                                    confirmButtonClass: "btn btn-success"
                                });
...
function modalExport() {
    ...
    &dt_start=${$('#dt-start').val()}
    &dt_end=${$('#dt-end').val()}
    &type=publicationTelegramChannel`, function (response) {
        Swal.fire({
            title: GLOBAL_LANG.telegram_channel_alert_export_title,
            text: GLOBAL_LANG.telegram_channel_alert_export_text,
            type: 'success',
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            confirmButtonText: GLOBAL_LANG.telegram_channel_alert_export_confirmButtonText
        });
    });
}
...
function changeTypeWarning(type) {
    ...
    swal({
        title: GLOBAL_LANG.telegram_channel_alert_change_type_title,
        text: GLOBAL_LANG.telegram_channel_alert_change_type_text,
        type: "warning",
        showCancelButton: !0,
        buttonsStyling: !1,
        reverseButtons: true,
        confirmButtonClass: "btn btn-success",
        confirmButtonText: GLOBAL_LANG.telegram_channel_alert_change_type_yes,
        cancelButtonClass: "btn btn-danger",
        cancelButtonText: GLOBAL_LANG.telegram_channel_alert_change_type_no,
    }).then(t => {
        if (t.value == true) {
...
function alertEditDatatable(status) {
    ...
    switch (status) {
        case '2':
            message = GLOBAL_LANG.telegram_channel_datatables_edit_status_2
            break;
        case '5':
            message = GLOBAL_LANG.telegram_channel_datatables_edit_status_5
            break;
        case '1':
        case '6':
            message = GLOBAL_LANG.telegram_channel_datatables_edit_status_6
            break;
        default:
            message = GLOBAL_LANG.telegram_channel_datatables_edit_default
            break;
    }
...
async function validateField() {
    return new Promise((resolve) => {
        ...
        const selected_channels = document.getElementById('multiselect').value;
